...
namespace WebServiceReference
{
    ...
    public interface ISoapService
    {
        ...
        System.Threading.Tasks.Task<WebServiceReference.SumResponse> SumAsync(WebServiceReference.SumRequest request);
    }
    ...
    public partial class SumRequest
    {
        ...
        public WebServiceReference.SumRequestBody Body;

        public SumRequest()
        {
        }

        public SumRequest(WebServiceReference.SumRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class SumRequestBody
    {
        ...
        public SumRequestBody(int a, int b)
        {
            this.a = a;
            this.b = b;
        }
    ...
    public partial class SumResponse
    {
        ...
        public WebServiceReference.SumResponseBody Body;

        public SumResponse()
        {
        }

        public SumResponse(WebServiceReference.SumResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class SoapServiceClient : System.ServiceModel.ClientBase<WebServiceReference.ISoapService>, WebServiceReference.ISoapService
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<WebServiceReference.SumResponse> WebServiceReference.ISoapService.SumAsync(WebServiceReference.SumRequest request)
        {
            return base.Channel.SumAsync(request);
        }

        public System.Threading.Tasks.Task<WebServiceReference.SumResponse> SumAsync(int a, int b)
        {
            WebServiceReference.SumRequest inValue = new WebServiceReference.SumRequest();
            inValue.Body = new WebServiceReference.SumRequestBody();
            inValue.Body.a = a;
            inValue.Body.b = b;
            return ((WebServiceReference.ISoapService)(this)).SumAsync(inValue);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ISoapService_soap))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:7019/Service.asmx");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
